// originally from SheetsJS js-xlsx in the mega xlsx.js file.
"use strict";
...
function make_json_row(sheet, r, R, cols, header, hdr, dense, o) {
  var rr = encode_row(R);
	var defval = o.defval;
	var raw = o.raw || !Object.prototype.hasOwnProperty.call(o, "raw");
  var isempty = true;
	var row = (header === 1) ? [] : {};
...
exports.sheet_to_json = function sheet_to_json(sheet, opts) {
...
exports.write_json_stream = function write_json_stream(sheet, opts) {
  var stream = Readable({
    objectMode: true
  });
...
exports.json_to_sheet = function json_to_sheet(js, opts) {
